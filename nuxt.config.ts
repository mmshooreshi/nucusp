  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        // Facebook
        { property: 'author', content: 'nucusp' },
        { property: 'og:site_name', content: 'nucusp.com' },
        { property: 'og:locale', content: 'en_US' },
        { property: 'og:type', content: 'website' },
        // Twitter
        { property: 'twitter:site', content: 'nucusp.com' },
        { property: 'twitter:domain', content: 'nucusp.com' },
        { property: 'twitter:creator', content: 'nucusp' },
